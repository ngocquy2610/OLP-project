...
ActiveRecord::Schema[8.1].define(version: 2026_05_26_064506) do
  ...
  create_table "likes", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "feedback_course_id", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["feedback_course_id"], name: "index_likes_on_feedback_course_id"
    t.index ["user_id", "feedback_course_id"], name: "index_likes_on_user_id_and_feedback_course_id", unique: true
  ...
  add_check_constraint "users", "phone IS NOT NULL AND btrim(phone::text) <> ''::text AND char_length(phone::text) >= 10 AND char_length(phone::text) <= 11 AND phone::text ~ '^\\d{10,11}$'::text", name: "users_phone_format_check", validate: false
  ...
  add_foreign_key "likes", "feedback_courses"
