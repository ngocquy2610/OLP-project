class PaymentMailer < ApplicationMailer
    ...
    def student_receipt_email(student, order)
        ...
        if pdf_file.present? && pdf_file.bytesize.positive?
            attachments[I18n.t("mailers.payment_mailer.invoice_filename", order_id: @order.id)] = {
        ...
        subject_text = I18n.t(
            "mailers.payment_mailer.student_receipt.subject",
            count: @courses.size,
            course_name: @courses.first&.name
        )
        ...
        def teacher_notification_email(teacher, student, order)
                ...
                subject_text = I18n.t(
                    "mailers.payment_mailer.teacher_notification.subject",
                    count: @courses.size,
